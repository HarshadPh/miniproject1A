...
public class Search  {
	...
	Search(){
		...
		f.setTitle("Wildlife Tourism : Search page");
	...
	ImageIcon img12= new ImageIcon(this.getClass().getResource("4742301.jpg"));
	lblNewLabel_1.setIcon(img12);
	//lblNewLabel_1.setIcon(new ImageIcon("C:\\Users\\Admin\\OneDrive\\Pictures\\java\\4742301.jpg"));
	lblNewLabel_1.setBounds(823, 10, 703, 740);
	f.getContentPane().add(lblNewLabel_1);
	
	JLabel lblNewLabel_2 = new JLabel("New label");
	lblNewLabel_2.setBounds(-690, 10, 1520, 740);
...
//	btnNewButton.setFont(new Font("Ebrima", Font.BOLD, 16));
	...
	JButton btnBooking = new JButton("Back");
	...
	btnBooking.setBackground(new Color(100, 149, 237));
		...
		public void actionPerformed(ActionEvent e) {
			...
			try {
				...
				if(sanname.isSelected()) {
					...
					Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/tourism","root","100480abc");
			        Statement stmt=con.createStatement();
					String san=textField.getText();
					...
					Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/tourism","root","100480abc");
			        Statement stmt=con.createStatement();
					String animal=textField.getText();
			        ...
			        String san=textField.getText();
			        String animal=textField.getText();
					String sql="select no_,sanctury_name,near_tourist_place,District from sanct where sanctury_name="+"'"+san+"'"+" or"+" a7="+"'"+animal+"'"+" or A1="+"'"+animal+"'"+" or A2="+"'"+animal+"'"+" or A3="+"'"+animal+"'"+" or A4="+"'"+animal+"'"+" or A5="+"'"+animal+"'" +" or A6="+"'"+animal+"'"+" or District="+"'"+animal+"'" ;
					ResultSet rs=stmt.executeQuery(sql);
					table.setModel(DbUtils.resultSetToTableModel(rs));
					table.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
